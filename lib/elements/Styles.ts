...
export class Styles {
 ...
 /**
  ...
  public static buildResourceFile(bookData: BookDataType){
    ...
    // On procède comme les autres fichiers de ressource : on copie 
    // le fichier modèle et on ajuste les contenus propres.

    throw new Error("Je dois apprendre à définir les styles.")
    
    return ;

    // Normalement, on ne doit pas avoir besoin de la suite : travailler
